...
<?xml-model href="https://pds.nasa.gov/pds4/geom/v1/PDS4_GEOM_1N00_19A0.sch" schematypens="http://purl.oclc.org/dsdl/schematron"?>
...
### *body_spice_name*  `in Coordinate_Space_SPICE`  
The body_spice_name attribute is a NAIF-recognized string identifier for a physical object (spacecraft, planet, instrument transmitter, system barycenter, etc.), associated with the data.  
- PDS4 data type: ASCII_Short_String_Collapsed  
- Valid values: N/A  
- Minimum Length: 1  
...
### *body_spice_name*  `in Coordinate_System_Origin_Identification`  
The body_spice_name attribute is a NAIF-recognized string identifier for a physical object (spacecraft, planet, instrument transmitter, system barycenter, etc.), associated with the data.  
- PDS4 data type: ASCII_Short_String_Collapsed  
- Valid values: N/A  
- Minimum Length: 1  
...
### *body_spice_name*  `in Geometry_Target_Identification`  
The body_spice_name attribute is a NAIF-recognized string identifier for a physical object (spacecraft, planet, instrument transmitter, system barycenter, etc.), associated with the data.  
- PDS4 data type: ASCII_Short_String_Collapsed  
- Valid values: N/A  
- Minimum Length: 1  
...
### *body_spice_name*  `in Observer_Identification`  
The body_spice_name attribute is a NAIF-recognized string identifier for a physical object (spacecraft, planet, instrument transmitter, system barycenter, etc.), associated with the data.  
- PDS4 data type: ASCII_Short_String_Collapsed  
- Valid values: N/A  
- Minimum Length: 1  
...
### *celestial_north_clock_angle*  `in Object_Orientation_RA_Dec`  
The celestial_north_clock_angle attribute specifies the direction of celestial north at the center of an image. It is measured from the 'upward' direction, clockwise to the direction toward celestial north, assuming the image is displayed as defined by the Display_Direction class.  
- PDS4 data type: ASCII_Real  
- Valid values: N/A  
- Minimum value: 0  
...
### *comment*  `in Illumination_Geometry`  
The comment attribute is a character string expressing one or more remarks or thoughts relevant to the object.  
- PDS4 data type: ASCII_Short_String_Collapsed  
- Valid values: N/A  
- Minimum Length: 1  
...
### *comment*  `in Reference_Frame_Identification`  
The comment attribute is a character string expressing one or more remarks or thoughts relevant to the object.  
- PDS4 data type: ASCII_Short_String_Collapsed  
- Valid values: N/A  
- Minimum Length: 1  
...
### *ecliptic_north_clock_angle*  `in Object_Orientation_RA_Dec`  
The ecliptic_north_clock_angle attribute specifies the direction of ecliptic north at the center of an image. It is measured from the 'upward' direction, clockwise to the direction toward ecliptic north, assuming the image is displayed as defined by the Display_Direction class.  
- PDS4 data type: ASCII_Real  
- Valid values: N/A  
- Minimum value: 0  
...
### *emission_angle*  `in Derived_Geometry`  
...
### *emission_angle*  `in Illumination_Specific`  
The emission_angle element provides the value of the angle between the surface normal vector at the intercept point and a vector from the intercept point to the spacecraft. The emission_angle varies from 0 degrees when the spacecraft is viewing the subspacecraft point (nadir viewing) to 90 degrees when the intercept is tangent to the surface of the target body. Thus, higher values of emission_angle indicate more oblique viewing of the target. For ring data, values in the range of 90 to 180 degrees indicate viewing on the unlit side from oblique or edge-on at 90 degrees to the unlit nadir at 180 degrees.  
- PDS4 data type: ASCII_Real  
- Valid values: N/A  
- Minimum value: 0  
...
### *frame_spice_name*  `in Coordinate_Space_SPICE`  
...
### *frame_spice_name*  `in Reference_Frame_Identification`  
The frame_spice_name attribute is a NAIF-recognized string identifier for a reference frame associated with the data.  
- PDS4 data type: ASCII_Short_String_Collapsed  
- Valid values: N/A  
- Minimum Length: 1  
...
### *frame_spice_name*  `in Rotate_From`  
The frame_spice_name attribute is a NAIF-recognized string identifier for a reference frame associated with the data.  
- PDS4 data type: ASCII_Short_String_Collapsed  
- Valid values: N/A  
- Minimum Length: 1  
...
### *incidence_angle*  `in Illumination_Specific`  
The incidence_angle element provides a measure of the lighting condition at the intercept point. Incidence angle is the angle between the local vertical at the intercept point (surface) and a vector from the intercept point to the sun. The incidence_angle varies from 0 degrees when the intercept point coincides with the subsolar point to 90 degrees when the intercept point is at the terminator (i.e., in the shadowed or dark portion of the target body).  
- PDS4 data type: ASCII_Real  
- Valid values: N/A  
- Minimum value: 0  
...
### *local_identifier*  `in Central_Body_Identification`  
The local_identifier attribute provides a character string which uniquely identifies the containing object within the label.  
- PDS4 data type: ASCII_Local_Identifier  
- Valid values: N/A  
- Minimum Length: 1  
...
### *local_identifier*  `in Coordinate_Space_Definition`  
The local_identifier attribute provides a character string which uniquely identifies the containing object within the label.  
- PDS4 data type: ASCII_Local_Identifier  
- Valid values: N/A  
- Minimum Length: 1  
...
### *local_identifier*  `in Coordinate_System_Origin_Identification`  
The local_identifier attribute provides a character string which uniquely identifies the containing object within the label.  
- PDS4 data type: ASCII_Local_Identifier  
- Valid values: N/A  
- Minimum Length: 1  
...
### *local_identifier*  `in Device_Angle`  
The local_identifier attribute provides a character string which uniquely identifies the containing object within the label.  
- PDS4 data type: ASCII_Local_Identifier  
- Valid values: N/A  
- Minimum Length: 1  
...
### *local_identifier*  `in Device_Component_State`  
The local_identifier attribute provides a character string which uniquely identifies the containing object within the label.  
- PDS4 data type: ASCII_Local_Identifier  
- Valid values: N/A  
- Minimum Length: 1  
...
### *local_identifier*  `in Device_Motor_Counts`  
The local_identifier attribute provides a character string which uniquely identifies the containing object within the label.  
- PDS4 data type: ASCII_Local_Identifier  
- Valid values: N/A  
- Minimum Length: 1  
...
### *local_identifier*  `in Device_Temperature`  
The local_identifier attribute provides a character string which uniquely identifies the containing object within the label.  
- PDS4 data type: ASCII_Local_Identifier  
- Valid values: N/A  
- Minimum Length: 1  
...
### *local_identifier*  `in Geometry_Lander`  
The local_identifier attribute provides a character string which uniquely identifies the containing object within the label.  
- PDS4 data type: ASCII_Local_Identifier  
- Valid values: N/A  
- Minimum Length: 1  
...
### *local_identifier*  `in Geometry_Target_Identification`  
The local_identifier attribute provides a character string which uniquely identifies the containing object within the label.  
- PDS4 data type: ASCII_Local_Identifier  
- Valid values: N/A  
- Minimum Length: 1  
...
### *local_identifier*  `in Motion_Counter`  
The local_identifier attribute provides a character string which uniquely identifies the containing object within the label.  
- PDS4 data type: ASCII_Local_Identifier  
- Valid values: N/A  
- Minimum Length: 1  
...
### *local_identifier*  `in Observer_Identification`  
The local_identifier attribute provides a character string which uniquely identifies the containing object within the label.  
- PDS4 data type: ASCII_Local_Identifier  
- Valid values: N/A  
- Minimum Length: 1  
...
### *local_identifier*  `in Reference_Frame_Identification`  
The local_identifier attribute provides a character string which uniquely identifies the containing object within the label.  
- PDS4 data type: ASCII_Local_Identifier  
- Valid values: N/A  
- Minimum Length: 1  
...
### *local_identifier*  `in Rotate_From`  
The local_identifier attribute provides a character string which uniquely identifies the containing object within the label.  
- PDS4 data type: ASCII_Local_Identifier  
- Valid values: N/A  
- Minimum Length: 1  
...
### *name*  `in Coordinate_System_Origin_Identification`  
The name attribute provides a word or combination of words by which the object is known.  
- PDS4 data type: UTF8_Short_String_Collapsed  
- Valid values: N/A  
- Minimum Length: 1  
...
### *name*  `in Geometry_Target_Identification`  
The name attribute provides a word or combination of words by which the object is known.  
- PDS4 data type: UTF8_Short_String_Collapsed  
- Valid values: N/A  
- Minimum Length: 1  
...
### *name*  `in Observer_Identification`  
The name attribute provides a word or combination of words by which the object is known.  
- PDS4 data type: UTF8_Short_String_Collapsed  
- Valid values: N/A  
- Minimum Length: 1  
...
### *name*  `in Reference_Frame_Identification`  
The name attribute provides a word or combination of words by which the object is known.  
- PDS4 data type: UTF8_Short_String_Collapsed  
- Valid values: N/A  
- Minimum Length: 1  
...
### *phase_angle*  `in Illumination_Specific`  
The phase_angle element provides a measure of the relationship between the instrument viewing position and incident illumination (such as solar light). Phase angle is measured at the target; it is the angle between a vector to the illumination source and a vector to the instrument. If illumination is from behind the instrument, phase_angle will be small.  
- PDS4 data type: ASCII_Real  
- Valid values: N/A  
- Minimum value: 0  
...
### *quaternion_measurement_method*  `in Coordinate_Space_Quality`  
Specifies the method by which the coordinate space was measured. This provides an indication of the quality of the definition.  
- PDS4 data type: ASCII_Short_String_Collapsed  
- Valid values:  
  - Bundle_Adjustment  
...
### *reference_location*  `in Pixel_Size_Projected`  
The reference_location indicates the position to which values in the containing class apply. If the reference location is on a target, the target is the one specified in the parent Geometry_Orbiter class.  
- PDS4 data type: ASCII_Short_String_Collapsed  
- Valid values:  
  - Boresight Intercept Point  
